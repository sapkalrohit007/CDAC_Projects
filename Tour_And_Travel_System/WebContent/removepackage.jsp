...
<%@include file="indexadmin.jsp" %>
  <div class="container">
  <h2 class="col-sm-offset-4" >DELETE PACKAGE </h2>
  <form class="form-horizontal" action="removepackage" method="POST" >
    <div class="form-group">
      <label class="control-label col-sm-4">Package Id</label>
      <div class="col-sm-4">
        <input type="number" class="form-control" id="state" placeholder="Enter Package Id" name="packageid">
      </div>
    </div>             
