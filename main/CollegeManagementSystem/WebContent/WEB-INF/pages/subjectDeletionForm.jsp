...
<div class="container">
  ...
  <form class="form-horizontal" action="deleteSubject" method="POST">
    <div class="form-group">
      <label class="control-label col-sm-4" for="sid">Enter subject ID to be deleted:</label>
      <div class="col-sm-4">      
        <input type="number" class="form-control" id="sid" placeholder="Subject Id" name="subId" required="required">
      </div>
    </div>
    <div class="form-group">        
