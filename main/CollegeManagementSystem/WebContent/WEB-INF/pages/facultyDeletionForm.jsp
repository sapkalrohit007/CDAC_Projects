...
<div class="container">
  ...
  <form class="form-horizontal" action="deleteFaculty" method="POST">
    <div class="form-group">
      <label class="control-label col-sm-4" for="fid">Enter faculty ID to be deleted:</label>
      <div class="col-sm-4">      
        <input type="number" class="form-control" id="fid" placeholder="Faculty Id" name="facultyId" required="required">
      </div>
    </div>
    <div class="form-group">        
